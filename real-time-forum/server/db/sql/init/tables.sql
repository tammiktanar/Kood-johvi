...
(
    ...
    `birthday`    DATE        NOT NULL DEFAULT '0001-01-01 00:00:00',
    `gender`      FLOAT       NOT NULL DEFAULT 0.5,
...
CREATE INDEX IF NOT EXISTS messages_SR
    ON messages (sender, receiver);

CREATE INDEX IF NOT EXISTS messages_RS
    ON messages (receiver, sender);
